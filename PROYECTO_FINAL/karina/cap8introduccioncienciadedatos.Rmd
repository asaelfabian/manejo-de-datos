...
Estos conceptos son fundamentales para estudiar redes en diversas disciplinas, como sociología, biología, informática y logística. Permiten modelar, analizar y optimizar sistemas de comunicación, transporte y organización.
...
El conjunto de datos está en un archivo de texto que contiene una lista de bordes, con un borde por línea. Ahora, en R, podemos cargar la red de Facebook y extraer información básica del gráfico, como el número de nodos, aristas y el grado promedio, con el siguiente código:
